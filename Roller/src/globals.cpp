...
pros::Motor leftBotRearDrive(L_TOP_REAR, pros::E_MOTOR_GEARSET_06, true);
pros::Motor leftFrontDrive(L_FRONT, pros::E_MOTOR_GEARSET_06, true);
pros::Motor rightTopRearDrive(R_TOP_REAR, pros::E_MOTOR_GEARSET_06, true);
pros::Motor rightBotRearDrive(R_BOT_REAR, pros::E_MOTOR_GEARSET_06, false);
pros::Motor rightFrontDrive(R_FRONT, pros::E_MOTOR_GEARSET_06, true);
